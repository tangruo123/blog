# Generated by Django 2.2.1 on 2019-05-14 04:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.OneToOneField(default='', on_delete=django.db.models.deletion.CASCADE, to='blog.Article', verbose_name='指向的文章')),
            ],
            options={
                'verbose_name': '轮播图',
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.Category', verbose_name='文章分类名'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(blank=True, to='blog.Tag', verbose_name='文章标签名'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
